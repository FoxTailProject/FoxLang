...
public:
	...
	virtual void visit(StringLiteralAST &it) = 0;
	virtual void visit(BoolLiteralAST &it) = 0;
	virtual void visit(StructLiteralAST &it) = 0;
	...
	virtual void visit(StructMemberAST &it) = 0;
